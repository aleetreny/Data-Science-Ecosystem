...
[Portfolio](../README.md) · [Execution guide](../RUNNING.md) · [Report source](Report.qmd)
...
Starting with a dataset of over 8,000 observations and 153 variables, the analysis proceeds as follows:
...
| File | Description |
| :--- | :--- |
| [Report.qmd](Report.qmd) | The **primary narrative document**. A Quarto file that generates a fully formatted HTML/PDF report containing the methodology, code, visualizations, and final conclusions. |
| [Code.R](Code.R) | The **raw R script** containing the complete analysis pipeline. It includes data cleaning, correlation matrices, PCA calculation, and advanced plotting (2D Biplots, 3D interactive plots). |
| [df_koi.csv](df_koi.csv) | The **dataset**. A subset of the NASA Exoplanet Archive containing the Kepler KOI data used for this analysis. |
